// <copyright file="SimpleCalculatorAPIClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace SimpleCalculatorAPI.Standard
{
    using System;
    ...
    using System.Net;
    using System.Text;
    using SimpleCalculatorAPI.Standard.Authentication;
    using SimpleCalculatorAPI.Standard.Controllers;
    ...
    /// </summary>
    public sealed class SimpleCalculatorAPIClient : IConfiguration
    {
        ...
        private readonly Lazy<BasicCalculatorController> basicCalculator;
        private readonly Lazy<APIController> client;

        private SimpleCalculatorAPIClient(
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.basicCalculator = new Lazy<BasicCalculatorController>(
                () => new BasicCalculatorController(this, this.httpClient, this.authManagers, this.httpCallBack));
            this.client = new Lazy<APIController>(
                () => new APIController(this, this.httpClient, this.authManagers, this.httpCallBack));
        }

        /// <summary>
        /// Gets BasicCalculatorController controller.
        /// </summary>
        public BasicCalculatorController BasicCalculatorController => this.basicCalculator.Value;
        ...
        /// <summary>
        /// Creates an object of the SimpleCalculatorAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> SimpleCalculatorAPIClient.</returns>
        internal static SimpleCalculatorAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("SIMPLE_CALCULATOR_API_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = SimpleCalculatorAPI.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>SimpleCalculatorAPIClient.</returns>
            public SimpleCalculatorAPIClient Build()
            {
                this.httpClient = new HttpClientWrapper(this.httpClientConfig.Build());

                return new SimpleCalculatorAPIClient(
                    this.environment,
                    this.authManagers,
                    this.httpClient,
                    this.httpCallBack,
