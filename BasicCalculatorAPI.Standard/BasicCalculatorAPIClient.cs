// <copyright file="BasicCalculatorAPIClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace BasicCalculatorAPI.Standard
{
    using System;
    ...
    /// </summary>
    public sealed class BasicCalculatorAPIClient : IConfiguration
    {
        ...
        private BasicCalculatorAPIClient(
        ...
        /// <summary>
        /// Creates an object of the BasicCalculatorAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> BasicCalculatorAPIClient.</returns>
        internal static BasicCalculatorAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("BASIC_CALCULATOR_API_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = BasicCalculatorAPI.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>BasicCalculatorAPIClient.</returns>
            public BasicCalculatorAPIClient Build()
            {
                this.httpClient = new HttpClientWrapper(this.httpClientConfig.Build());

                return new BasicCalculatorAPIClient(
                    this.environment,
                    this.authManagers,
                    this.httpClient,
                    this.httpCallBack,
